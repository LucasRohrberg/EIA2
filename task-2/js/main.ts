...
let Deck: Card[] = [{ type: "hearts", score: "7" }, { type: "hearts", score: "8" }, { type: "hearts", score: "9" }, { type: "hearts", score: "10" }, { type: "hearts", score: "jack" }, { type: "hearts", score: "queen" }, { type: "hearts", score: "king" }, { type: "hearts", score: "ace" },
...
function getCardAmount(): number {
    let enterCardAmount: string = prompt("Enter the amount of cards the player gets:");
    let cardAmount: number = Number(enterCardAmount);
    return cardAmount;
}
